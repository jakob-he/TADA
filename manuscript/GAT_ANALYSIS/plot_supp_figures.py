...
def main():
    ...
    ax1.barh(patho_bars, patho_df['l2fold'], height=barheight, color = '#913a1d', linewidth=1.5,edgecolor='#781e00', label='Pathogenic')
    ax1.barh(nonpatho_bars, nonpatho_df['l2fold'], height=barheight, color = '#1d9191', linewidth=1.5,edgecolor='#007878', label='Non-Pathogenic')
    ...
    sizes = [min(100,abs(300*fold)) for fold in compare_df['observed']]
    ...
    ax1.set_yticklabels(labels=compare_df['annotation'])
