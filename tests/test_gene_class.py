...
class TestGeneLoading(unittest.TestCase):
    ...
    def test_data_load(self):
        ...
        self.assertEqual(gene_beds[0].start,70000,'The first bed entry is not loaded properly!')
        self.assertEqual(gene_beds[1].end,300200,'The second bed entry is not loaded properly!')
