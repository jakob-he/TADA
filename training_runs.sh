...
#5. Run
#Basic continous features: GnomAD genes distance, FANTOM5 enhancer distance, TAD boundariy distance
...
python3 classification_run.py -c1 classification_run_5/non_pathogenic_cnvs.p -c2 classification_run_5/pathogenic_cnvs.p -f basic_continous -cls lr -kw solver=liblinear -o classification_run_5 > classification_run_5/log_lr.txt
python3 classification_run.py -c1 classification_run_5/non_pathogenic_cnvs.p -c2 classification_run_5/pathogenic_cnvs.p -f basic_continous -cls rf -o classification_run_5 > classification_run_5/log_rf.txt
...
python3 classification_run.py -c1 classification_run_6/non_pathogenic_cnvs.p -c2 classification_run_6/pathogenic_cnvs.p -f basic_continous -cls lr -kw solver=liblinear -o classification_run_6 > classification_run_6/log_lr.txt
python3 classification_run.py -c1 classification_run_6/non_pathogenic_cnvs.p -c2 classification_run_6/pathogenic_cnvs.p -f basic_continous -cls rf -o classification_run_6 > classification_run_6/log_rf.txt

#7. Run
#This Run includes the UK biobank variants
#Extended continous features: GnomAD genes distance, DDG2P genes distance, FANTOM5 enhancer distance, TAD boundary distance, CTCF binding site distance, pLi of the closest gene, enhancer conservation of the closest gene, haploinsufficiency of the closest gene
...
python3 annotate_cnvs.py -t classification_run_7/annotated_TADs.p -c /project/GENTLE_SCRATCH/DATA/REFERENCE_STRUCTURAL_VARIANTS/shared_variants_audano_gnomad_biobank_filtered.bed -o classification_run_7/non_pathogenic_cnvs.p
...
python3 classification_run.py -c1 classification_run_7/non_pathogenic_cnvs.p -c2 classification_run_7/pathogenic_cnvs.p -f extended_continous -cls lr -kw solver=liblinear -o classification_run_7 > classification_run_7/log_lr.txt
python3 classification_run.py -c1 classification_run_7/non_pathogenic_cnvs.p -c2 classification_run_7/pathogenic_cnvs.p -f extended_continous -cls rf -o classification_run_7 > classification_run_7/log_rf.txt
